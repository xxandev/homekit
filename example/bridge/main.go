...
func main() {
	// log.Debug.Enable()
	bridge := accessory.NewBridge(accessory.Info{Name: "Bridge", SerialNumber: "Ex-Brg", Model: "HAP-BRG", Manufacturer: homekit.Manufacturer, FirmwareRevision: homekit.Revision})
	transp, err := hc.NewIPTransport(hc.Config{StoragePath: "./" + bridge.Info.SerialNumber.GetValue(), Pin: "11223344"}, bridge.Accessory,
		func() (accs []*accessory.Accessory) {
