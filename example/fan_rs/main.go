...
const (
	...
	SN      string = "EX-Fan"
	MODEL   string = "HAP-FN"
	ADDRESS string = ":11104"
	PIN     string = "12344321"
)

func main() {
	homekit.OnLog(false)
	acc := homekit.NewAccessoryFanRS(accessory.Info{Name: NAME, SerialNumber: SN, Model: MODEL, Manufacturer: homekit.Manufacturer, Firmware: homekit.Firmware})
