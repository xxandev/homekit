...
const (
	NAME    string = "Smoke"
	SN      string = "EX-Smoke"
	MODEL   string = "HAP-SRSMK"
	ADDRESS string = ":11123"
	PIN     string = "12344321"
)

func main() {
	homekit.OnLog(false)
	acc := homekit.NewAccessorySensorSmoke(accessory.Info{Name: NAME, SerialNumber: SN, Model: MODEL, Manufacturer: homekit.Manufacturer, Firmware: homekit.Firmware})
