...
const (
	...
	SN      string = "EX-ThermUC"
	MODEL   string = "HAP-TRMUC"
	ADDRESS string = ":11131"
	PIN     string = "12344321"
)

func main() {
	homekit.OnLog(false)
	acc := homekit.NewAccessoryThermostat(accessory.Info{Name: NAME, SerialNumber: SN, Model: MODEL, Manufacturer: homekit.Manufacturer, Firmware: homekit.Firmware}, 3, 3, 3, 0)
