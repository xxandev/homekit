...
const (
	NAME    string = "Humidity"
	SN      string = "EX-Humidity"
	MODEL   string = "HAP-SRHUM"
	ADDRESS string = ":11118"
	PIN     string = "12344321"
)

func main() {
	homekit.OnLog(false)
	acc := homekit.NewAccessorySensorHumidity(accessory.Info{Name: NAME, SerialNumber: SN, Model: MODEL, Manufacturer: homekit.Manufacturer, Firmware: homekit.Firmware})
