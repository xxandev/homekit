...
const (
	...
	SN      string = "EX-ThermA"
	MODEL   string = "HAP-TRMA"
	ADDRESS string = ":11128"
	PIN     string = "12344321"
)

func main() {
	homekit.OnLog(false)
	acc := homekit.NewAccessoryThermostatAutomatic(accessory.Info{Name: NAME, SerialNumber: SN, Model: MODEL, Manufacturer: homekit.Manufacturer, Firmware: homekit.Firmware})
