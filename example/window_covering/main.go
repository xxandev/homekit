...
const (
	NAME    string = "WindowCovering"
	SN      string = "EX-WindowCovering"
	MODEL   string = "HAP-WNDCWR"
	ADDRESS string = ":11134"
	PIN     string = "12344321"
)

func main() {
	homekit.OnLog(false)
	acc := homekit.NewAccessoryWindowCovering(accessory.Info{Name: NAME, SerialNumber: SN, Model: MODEL, Manufacturer: homekit.Manufacturer, Firmware: homekit.Firmware})
