...
func main() {
	...
	// log.Debug.Enable()
	acc := homekit.NewAccessoryIrrigation(accessory.Info{Name: accessoryName, SerialNumber: accessorySn, Manufacturer: "alpr777", Model: "ACC-TEST", FirmwareRevision: "1.2"})
