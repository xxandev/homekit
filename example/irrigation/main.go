...
const (
	NAME    string = "Irrigation"
	SN      string = "EX-Irrigation"
	MODEL   string = "HAP-IRG"
	ADDRESS string = ":11109"
	PIN     string = "12344321"
)

func main() {
	homekit.OnLog(false)
	acc := homekit.NewAccessoryIrrigation(accessory.Info{Name: NAME, SerialNumber: SN, Model: MODEL, Manufacturer: homekit.Manufacturer, Firmware: homekit.Firmware})
