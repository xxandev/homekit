...
const (
	NAME    string = "Outlet"
	SN      string = "EX-Outlet"
	MODEL   string = "HAP-OTL"
	ADDRESS string = ":11113"
	PIN     string = "12344321"
)

func main() {
	homekit.OnLog(false)
	acc := homekit.NewAccessoryOutlet(accessory.Info{Name: NAME, SerialNumber: SN, Model: MODEL, Manufacturer: homekit.Manufacturer, Firmware: homekit.Firmware})
