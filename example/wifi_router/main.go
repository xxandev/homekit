...
const (
	NAME    string = "Router"
	SN      string = "EX-Router"
	MODEL   string = "HAP-RTR"
	ADDRESS string = ":11132"
	PIN     string = "12344321"
)

func main() {
	homekit.OnLog(false)
	acc := homekit.NewAccessoryWifiRouter(accessory.Info{Name: NAME, SerialNumber: SN, Model: MODEL, Manufacturer: homekit.Manufacturer, Firmware: homekit.Firmware})
