...
const (
	NAME    string = "Dioxide"
	SN      string = "EX-Dioxide"
	MODEL   string = "HAP-SRDXO"
	ADDRESS string = ":11117"
	PIN     string = "12344321"
)

func main() {
	homekit.OnLog(false)
	acc := homekit.NewAccessorySensorDioxide(accessory.Info{Name: NAME, SerialNumber: SN, Model: MODEL, Manufacturer: homekit.Manufacturer, Firmware: homekit.Firmware})
