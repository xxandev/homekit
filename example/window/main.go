...
const (
	NAME    string = "Window"
	SN      string = "EX-Window"
	MODEL   string = "HAP-WND"
	ADDRESS string = ":11133"
	PIN     string = "12344321"
)

func main() {
	homekit.OnLog(false)
	acc := homekit.NewAccessoryWindow(accessory.Info{Name: NAME, SerialNumber: SN, Model: MODEL, Manufacturer: homekit.Manufacturer, Firmware: homekit.Firmware})
