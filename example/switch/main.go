...
const (
	...
	SN      string = "EX-Switch"
	MODEL   string = "HAP-SW"
	ADDRESS string = ":11126"
	PIN     string = "12344321"
)

func main() {
	homekit.OnLog(false)
	acc := homekit.NewAccessorySwitch(accessory.Info{Name: NAME, SerialNumber: SN, Model: MODEL, Manufacturer: homekit.Manufacturer, Firmware: homekit.Firmware})
