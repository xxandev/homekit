...
const (
	NAME    string = "Faucet"
	SN      string = "EX-Faucet"
	MODEL   string = "HAP-FCT"
	ADDRESS string = ":11106"
	PIN     string = "12344321"
)

func main() {
	homekit.OnLog(false)
	acc := homekit.NewAccessoryFaucet(accessory.Info{Name: NAME, SerialNumber: SN, Model: MODEL, Manufacturer: homekit.Manufacturer, Firmware: homekit.Firmware})
