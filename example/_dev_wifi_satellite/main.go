...
const (
	accessoryName string = "satellite"
	accessorySn   string = "ExmplSTL"
...
func main() {
	...
	// log.Debug.Enable()
	acc := homekit.NewAccessoryWifiSatellite(accessory.Info{Name: accessoryName, SerialNumber: accessorySn, Manufacturer: "alpr777", Model: "ACC-TEST", FirmwareRevision: "1.2"})
