...
func main() {
	// log.Debug.Enable()
	acc := homekit.NewAccessoryFanSwitch(accessory.Info{Name: "Fan", SerialNumber: "Ex-Fan-Sw", Model: "HAP-FN-CTRL", Manufacturer: homekit.Manufacturer, FirmwareRevision: homekit.Revision})
