...
const (
	NAME    string = "Fan"
	SN      string = "EX-FanSw"
	MODEL   string = "HAP-FNSW"
	ADDRESS string = ":11105"
	PIN     string = "12344321"
)

func main() {
	homekit.OnLog(false)
	acc := homekit.NewAccessoryFanSwitch(accessory.Info{Name: NAME, SerialNumber: SN, Model: MODEL, Manufacturer: homekit.Manufacturer, Firmware: homekit.Firmware})
