...
const (
	NAME    string = "SecuritySys"
	SN      string = "EX-SecurSys"
	MODEL   string = "HAP-SECURSYS"
	ADDRESS string = ":11114"
	PIN     string = "12344321"
)

func main() {
	homekit.OnLog(false)
	acc := homekit.NewAccessorySecuritySystem(accessory.Info{Name: NAME, SerialNumber: SN, Model: MODEL, Manufacturer: homekit.Manufacturer, Firmware: homekit.Firmware})
