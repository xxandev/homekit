...
const (
	NAME    string = "Leak"
	SN      string = "EX-Leak"
	MODEL   string = "HAP-SRLK"
	ADDRESS string = ":11119"
	PIN     string = "12344321"
)

func main() {
	homekit.OnLog(false)
	acc := homekit.NewAccessorySensorLeak(accessory.Info{Name: NAME, SerialNumber: SN, Model: MODEL, Manufacturer: homekit.Manufacturer, Firmware: homekit.Firmware})
