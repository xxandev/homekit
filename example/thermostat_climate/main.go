...
func main() {
	// log.Debug.Enable()
	acc := homekit.NewAccessoryThermostat(accessory.Info{Name: "Thermostat", SerialNumber: "Ex-Therm-CLmt", Model: "HAP-TRM-CLM", Manufacturer: homekit.Manufacturer, FirmwareRevision: homekit.Revision})
