...
const (
	...
	SN      string = "EX-ThermC"
	MODEL   string = "HAP-TRMC"
	ADDRESS string = ":11129"
	PIN     string = "12344321"
)

func main() {
	homekit.OnLog(false)
	acc := homekit.NewAccessoryThermostat(accessory.Info{Name: NAME, SerialNumber: SN, Model: MODEL, Manufacturer: homekit.Manufacturer, Firmware: homekit.Firmware})
