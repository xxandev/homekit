...
const (
	NAME    string = "Light"
	SN      string = "EX-Light"
	MODEL   string = "HAP-SRLGT"
	ADDRESS string = ":11120"
	PIN     string = "12344321"
)

func main() {
	homekit.OnLog(false)
	acc := homekit.NewAccessorySensorLight(accessory.Info{Name: NAME, SerialNumber: SN, Model: MODEL, Manufacturer: homekit.Manufacturer, Firmware: homekit.Firmware})
